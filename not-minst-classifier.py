...
def make_arrays(nb_rows, img_size):
  """  
  	Creates a 3D array of type float and a 1D array of ints
  """
  if nb_rows:
...
get_uniques(valid_dataset, valid_labels, test_dataset, test_labels)

# print(s_test_dataset.shape, s_test_labels.shape, s_train_dataset.shape, s_train_labels.shape)
